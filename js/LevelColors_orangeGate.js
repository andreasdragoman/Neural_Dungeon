Game.LevelColors_orangeGate = function(game){
...
Game.LevelColors_orangeGate.prototype = {
...
//        
        ...
        //DOOR
        orange_big_door = this.add.sprite(1470   ,250,'orange_big_door');
        this.physics.arcade.enable(orange_big_door);
        orange_big_door.anchor.setTo(0.5,0.5);
        orange_big_door.body.collideWorldBounds = true;
        orange_big_door.body.immovable = true;
        //info cloud
        infoCloud_orangeGate = this.add.sprite(1150   ,150,'cloud_info'); //new CloudInfo(0,this.game,this.game.width-150, this.game.height/2);
        this.physics.arcade.enable(infoCloud_orangeGate);
        infoCloud_orangeGate.anchor.setTo(0.5,0.5);
        infoCloud_orangeGate.body.collideWorldBounds = true;
        infoCloud_orangeGate.body.immovable = true;
        infoCloud_orangeGate.inputEnabled = true;
        infoCloud_orangeGate.events.onInputDown.add(this.testMessageBox, this);
    ...
    update:function(){
    if(this.state.getCurrentState().key == 'LevelColors_orangeGate')
    {
        ...
        this.physics.arcade.collide(player,orange_big_door);
        this.physics.arcade.collide(player,infoCloud_orangeGate,this.teleportToAnotherTrainMap,null,this); //?? WTF
        ...
        if(checkOverlap(player,orange_big_door)){
            this.teleportToAnotherTrainMap();
        }
        
        if(infoCloud_orangeGate.input.pointerOver()){
            infoCloud_orangeGate.scale.setTo(1.5,1.5);
        }else{
            infoCloud_orangeGate.scale.setTo(1,1);
        }
    ...
    infoCloud_orangeGateMessage: function(){
    ...
    teleportToAnotherTrainMap: function(){
        this.state.start('LevelColors_grayGate');
    }
